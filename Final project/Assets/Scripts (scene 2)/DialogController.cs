...
public class DialogController : MonoBehaviour
{
    ...
    void Update ()
    {
        ...
        //Crab
        if (Vector3. Distance(gameObject.transform.position, Crab.transform.position) < 3 && Input.GetKeyDown(KeyCode.T))
        {
        ...
        //Titan
        if (Vector3. Distance(gameObject.transform.position, Titan.transform.position) < 3 && Input.GetKeyDown(KeyCode.T))
        {
        ...
        //Cave man
        if (Vector3. Distance(gameObject.transform.position, CaveMan.transform.position) < 3 && Input.GetKeyDown(KeyCode.T))
        {
        ...
        //Troll
        if (Vector3. Distance(gameObject.transform.position, Troll.transform.position) < 3 && Input.GetKeyDown(KeyCode.T))
        {
        ...
        //Demon girl
        if (Vector3. Distance(gameObject.transform.position, DemonGirl.transform.position) < 3 && Input.GetKeyDown(KeyCode.T))
        {
        ...
        //Piggy orc
        if (Vector3. Distance(gameObject.transform.position, PiggyOrc.transform.position) < 3 && Input.GetKeyDown(KeyCode.T))
        {
        ...
        //Woman warrior
        if (Vector3. Distance(gameObject.transform.position, WomanWarrior.transform.position) < 3 && Input.GetKeyDown(KeyCode.T))
        {
